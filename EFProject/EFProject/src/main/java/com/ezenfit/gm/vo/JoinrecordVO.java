...
public class JoinrecordVO {
	...
	public JoinrecordVO(String ef_id, String ef_name, String ef_r_count, Date ef_start_term, Date ef_end_term, String ef_p_type,
	...
	public String toString() {
		return "JoinrecordVO [ef_id=" + ef_id + ", ef_name=" + ef_name + ", ef_r_count=" + ef_r_count
				+ ", ef_start_term=" + ef_start_term + ", ef_end_term=" + ef_end_term + ", ef_p_type=" + ef_p_type
				+ ", ef_detail=" + ef_detail + ", ef_r_time=" + ef_r_time + ", ef_use=" + ef_use + "]";
	}
	
	
	
} // End - public class JoinrecordVO
